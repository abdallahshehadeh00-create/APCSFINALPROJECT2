...
3. Data Layer (Model/Persistence): Uses Medicine.java for data representation and JsonHandler.java for asynchronous-style file I/O operations.
 ...
 Search Algorithm: The search functionality utilizes a Predicate-based FilteredList, ensuring time complexity for real-time string matching across the inventory dataset.
